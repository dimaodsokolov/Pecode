...
#1 Write an automation script using Selenium WebDriver and Maven with Java as the language which will open: https://www.pecodesoftware.com/qa-portal/greet.php 
